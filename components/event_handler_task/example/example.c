...
void app_main(void)
{
    ...
    tank_config_t tank_config1 = {.id = 1, .capacity_in_liters = 36, .shape = TANK_SHAPE_RECTANGLE, .height_in_cm = 28, .full_level_in_mm = 70, .low_level_in_mm = 50};

    tank_config_t tank_config2 = {.id = 2, .capacity_in_liters = 40, .shape = TANK_SHAPE_RECTANGLE, .height_in_cm = 22, .full_level_in_mm = 50, .low_level_in_mm = 30};
    ...
    level_sensor_config_t sensor_config1 = {.id = 1, .sensor_addr = 0x01, .protocol = protocol, .medium_context = rs485_ttl, .send_recive = send_receive, .interpreter = interpret, .interface = LEVEL_SENSOR_INTERFACE_RS485, .level_sensor_protocol = GL_A01_PROTOCOL};

    level_sensor_config_t sensor_config2 = {.id = 2, .sensor_addr = 0x01, .protocol = protocol, .medium_context = rs485_ttl, .send_recive = send_receive, .interpreter = interpret, .interface = LEVEL_SENSOR_INTERFACE_RS485, .level_sensor_protocol = GL_A01_PROTOCOL};
