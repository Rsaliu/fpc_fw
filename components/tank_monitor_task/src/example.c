...
void tank_monitor_task_appMain(void)
{
    printf("Hello world!\n");
    ...
    tank_monitor_task_config.tank_monitor_count = 2;
      ...
      TaskHandle_t handle_other_task = NULL;
    
    xTaskCreate(&tank_monitor_task,"tank_monitor_task",4096, &tank_monitor_task_config,1,&handle_other_task);
}
